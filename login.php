...
<div class="container d-flex justify-content-center align-items-center" style="min-height: 80vh;">
    <div class="card shadow-lg p-4" style="max-width: 400px; width: 100%;">
        <div class="text-center mb-3">
            ...
            <h2 class="mb-2" style="font-weight: bold; color: #0d6efd;">Iniciar Sesión</h2>
            <p class="text-muted mb-3" style="font-size: 1rem;">Accedé a tu oficina virtual</p>
        </div>
        ...
        <?php if ($mensaje): ?>
            <div class="alert alert-danger mt-3 py-2 text-center" style="font-size: 0.95em;">
                <?php echo $mensaje; ?>
            </div>
        <?php endif; ?>
